...
namespace LeylaEditor.GameProject
{
    ...
    public class NewProject : ViewModelBase
	{
		...
		private readonly string _templatePath = @"..\..\LeylaEditor\ProjectTemplates\";
		...
		private string _projectPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments)}\LeylaProject\";
		...
		public string CreateProject(ProjectTemplate template)
		{
			...
			try
			{
				...
				var dirInfo = new DirectoryInfo(path + @".Leyla\");
