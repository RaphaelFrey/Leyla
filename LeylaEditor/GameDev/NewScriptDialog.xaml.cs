...
namespace {1} {{
    class {0} : public leyla::script::entity_script
    {{
    public:
        constexpr explicit {0}(leyla::game_entity::entity entity)
            : leyla::script::entity_script{{entity}} {{}}
